...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('47c0cdfe-cf45-4454-8f20-eaa4f994a530'), help_text='unique id for this particular book across whole library', primary_key=True, serialize=False)),
